...
public class Cargar extends javax.swing.JPanel {
    ...
    private void enviar_btnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_enviar_btnMousePressed
        ...
        if (anio.getText().isEmpty()||Integer.parseInt(anio.getText()) < 2000 || Integer.parseInt(anio.getText()) > 2022) {
            Component jFrame = null;
            JOptionPane.showMessageDialog(jFrame, ""
                    + "Error, solo se vende autos desde 2000 hasta 2022");
        } else {
            try {
                if(nro_chasis.getText().isEmpty()){
                    Component jFrame = null;
    ...
    private void enviar_btn1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_enviar_btn1MousePressed
            ...
            if (anio_c.getText().isEmpty()||Integer.parseInt(anio_c.getText()) < 2000 || Integer.parseInt(anio_c.getText()) > 2022) {
                Component jFrame = null;
                JOptionPane.showMessageDialog(jFrame, ""
                        + "Error, solo se vende autos desde 2000 hasta 2022");
                ...
                try {
                    if(nro_chasis_c.getText().isEmpty()){
                    Component jFrame = null;
                JOptionPane.showMessageDialog(jFrame, "Error, no ingreso un numero de chasis");
                }else{
                    for (int i = 0; i < Vehiculo.vehiculo.size(); i++) {
